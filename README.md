...
R package **remind2**, version **1.103.9**
...
Rodrigues R (2022). _remind2: The REMIND R package (2nd generation)_. R package version 1.103.9, <URL: https://github.com/pik-piam/remind2>.
...
@Manual{,
  ...
  year = {2022},
  note = {R package version 1.103.9},
