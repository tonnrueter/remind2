...
tot <- "FE|Industry|Steel"
items <- c(
  "FE|Industry|Steel|Primary|BF-BOF",
  "FE|Industry|Steel|Primary|IDR-EAF",
  "FE|Industry|Steel|Secondary|EAF")
showAreaAndBarPlots(data, items, tot, scales = "fixed")
}
```
