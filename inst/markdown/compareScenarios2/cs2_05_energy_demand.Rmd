...
```{r}
#!!!self reminder: try this out for new scenario runs from validation process
#then start corresponding PR

#Cement and other non-metallic minerals
var1 <- "FE|Industry|Specific Energy Consumption|Cement" # Your variable name here.
test1<- data %>% 
  filter(variable == var1) %>% 
  bind_rows(
    expand.grid(
      model = "Thermodynamic limit for cement", # Your description here.
      scenario = "historical", 
