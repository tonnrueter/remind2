...
if ("Production|Industry|Steel|Primary|BF-BOF" %in% levels(data$variable)){ # if process-based steel is used
tot <- "Production|Industry|Steel"
items <- c(
  "Production|Industry|Steel|Primary|BF-BOF",
  "Production|Industry|Steel|Primary|IDR-EAF",
  "Production|Industry|Steel|Secondary|EAF")
showAreaAndBarPlots(data, items, tot, scales = "fixed")
}
```
