...
primary <- data %>% 
  filter(variable %in% c('Production|Industry|Steel|Primary|per-capita')) %>% 
  calc_addVariable(
   '`Production|Industry|Steel|Primary|per-capita accumulation`' = 'cumsum(`Production|Industry|Steel|Primary|per-capita`)',
   units = 't'
  )
#to do:
...
showLinePlots(primary, 'Production|Industry|Steel|Primary|per-capita accumulation')
