...
showMultiLinePlots(data, items[1:3], scales="fixed")
showMultiLinePlots(data, items[4:5], scales="fixed")
showMultiLinePlotsByVariable(data, items[1:3], "GDP|PPP pCap", scales="fixed")
showMultiLinePlotsByVariable(data, items[4:5], "GDP|PPP pCap", scales="fixed")
```
...
showMultiLinePlotsByVariable(data, items, "GDP|PPP pCap", scales="fixed")
```
...
showMultiLinePlots(data, items[1:2], scales="fixed")
showMultiLinePlots(data, items[3:4], scales="fixed")
showMultiLinePlotsByVariable(data, items[1:2], "GDP|PPP pCap", scales="fixed")
showMultiLinePlotsByVariable(data, items[3:4], "GDP|PPP pCap", scales="fixed")
```
