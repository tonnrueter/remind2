...
tot <- "Emi|CO2"
# fix me: emi categories don't add up to total from sel_vm_emiAllMkt_co2
# this one is missing: vm_feedstockEmiUnknownFate
# I need to re-name them also Emi|CO2|Plastics incineration and Emi|CO2|Feedstocks unknown fate
items <- c(
