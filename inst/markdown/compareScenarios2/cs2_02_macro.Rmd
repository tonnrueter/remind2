...
carriers <- c("Electricity", "Gases", "Heat", "Hydrogen", "Liquids", "Solids")
vars <- intersect(levels(dPrice$variable), paste0("Price|Final Energy|Buildings|", carriers))
walk(vars, showLinePlots, data = dPrice, scale = "fixed")
```
...
carriers <- c("Electricity", "Gases", "Heat", "Hydrogen", "Liquids", "Solids")
vars <- intersect(levels(dPrice$variable), paste0("Price|Final Energy|Industry|", carriers))
walk(vars, showLinePlots, data = dPrice, scale = "fixed")
```
...
carriers <- c("Electricity", "Gases", "Heat", "Hydrogen", "Liquids", "Solids")
vars <- intersect(levels(dPrice$variable), paste0("Price|Final Energy|Transport|", carriers))
walk(vars, showLinePlots, data = dPrice, scale = "fixed")
```
