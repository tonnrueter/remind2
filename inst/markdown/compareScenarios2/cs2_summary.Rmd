...
```{r SE Wind Onshore}
show_default_line_plots(data, "SE|Electricity|Wind|Onshore")
```
...
```{r SE Wind Offshore}
show_default_line_plots(data, "SE|Electricity|Wind|Offshore")
```
...
show_default_line_plots(data, "Policy Cost|Consumption Loss")
```


```{r Policy Cost-Consumption Loss-Relative to Reference Consumption}
show_default_line_plots(data, "Policy Cost|Consumption Loss|Relative to Reference Consumption")
```


```{r Policy Cost-GDP Loss}
show_default_line_plots(data, "Policy Cost|GDP Loss")
```
