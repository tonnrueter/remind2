...
output:
  ...
  pdf_document:
    ...
    number_sections: yes
params:
  mif: !r c("C:/Users/chris/Documents/PIK/mif/REMIND/REMIND_generic_SSP2EU-AMT-NDC.mif", "C:/Users/chris/Documents/PIK/mif/REMIND/REMIND_generic_SSP2EU-AMT-PkBudg1520.mif")
...
showMultiLinePlots <- function(data, items, mainReg = "World") {
...
```{r include sections, child = paste0("cs2_", includes, ".Rmd")}
```
