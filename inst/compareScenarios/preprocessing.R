...
pCapVariables <- tribble(
  ...
  "FE|Buildings|Heating|Hydrogen", "GJ/yr", 1e9,
  "FE|Buildings|Heating|Gases", "GJ/yr", 1e9,
  "FE|Buildings|Heating|Liquids", "GJ/yr", 1e9,
  "FE|Buildings|Heating|Solids", "GJ/yr", 1e9,
  ...
  "UE|Buildings|Heating|Hydrogen", "GJ/yr", 1e9,
  "UE|Buildings|Heating|Gases", "GJ/yr", 1e9,
  "UE|Buildings|Heating|Liquids", "GJ/yr", 1e9,
  "UE|Buildings|Heating|Solids", "GJ/yr", 1e9,
