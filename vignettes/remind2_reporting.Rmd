...
Note that the definitions of REMIND variables as generated by the ``remind2`` library may not correspond to the definition of equally or similarly named variables in standardized model intercomparison projects. For mappings of REMIND variables to variable templates from model intercomparison projects, please see the pik-piam library [piamInterfaces](https://github.com/pik-piam/piamInterfaces).
