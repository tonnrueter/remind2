...
reportTechnology <- function(gdx, output = NULL, regionSubsetList = NULL, t = c(seq(2005, 2060, 5), seq(2070, 2110, 10), 2130, 2150)) {
  ...
  v33_EW_onfield <- readGDX(gdx,c("v33_EW_onfield"), restore_zeros = F,field="l",format="first_found")[,t,] # [Gt rock]
  ...
  v33_EW_onfield_tot <- readGDX(gdx,c("v33_EW_onfield_tot"), restore_zeros = F,field="l",format="first_found")[,t,] # [Gt rock]
