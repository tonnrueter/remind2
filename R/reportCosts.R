...
reportCosts <- function(gdx,output=NULL,regionSubsetList=NULL,t=c(seq(2005,2060,5),seq(2070,2110,10),2130,2150)) {
  ...
  cost3 <- op_costs(ei=NULL,eo=NULL,te=tenotransform,e2e=NULL,teall2rlf=teall2rlf,vm_prodE=NULL,pm_data=pm_data,vm_cap=vm_cap,v_investcost=v_investcost)
  tmp  <- mbind(tmp,setNames(cost1 + cost2 + cost3 + output[regi_on_gdx,,"Energy Investments|Electricity (billion US$2017/yr)"], "Total Energy costs|Electricity (billion US$2017/yr)"))
  ...
  if ("h2turb" %in% se2se$all_te) {
    ...
    tmp  <- mbind(tmp,setNames(cost + output[regi_on_gdx,,"Energy Investments|Electricity|Hydrogen (billion US$2017/yr)"], "Total Energy costs|Electricity|Hydrogen (billion US$2017/yr)"))
  }
  ...
  tmp  <- mbind(tmp,setNames(cost + output[regi_on_gdx,,"Energy Investments|Electricity|Storage (billion US$2017/yr)"], "Total Energy costs|Electricity|Storage (billion US$2017/yr)"))
  ...
  tmp  <- mbind(tmp,setNames(cost1 + cost2 + output[regi_on_gdx,,"Energy Investments|Electricity|Grid (billion US$2017/yr)"], "Total Energy costs|Electricity|Grid (billion US$2017/yr)"))
